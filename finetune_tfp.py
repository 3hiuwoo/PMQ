...
from model.encoder import TFPClassifier, TFPClassifier2
...
parser.add_argument('--second_mode', action='store_true', help='whether to use the second mode of the model')
...
parser.add_argument('--logdir', type=str, default='log_tfp', help='directory to save logs')
