...
parser.add_argument("--data", type=str, default="mimic", help="pretraining dataset: [mimic, chapman, ptb, ptbxl, cpsc2018]")
...
parser.add_argument("--sym", action="store_true", help="whether to compute the loss symmetrically when only use no queue")
# training
