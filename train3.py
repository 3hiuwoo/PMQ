...
import warnings
import numpy as np
from mopa import CMC
from data import load_data
from utils import seed_everything, get_device
warnings.filterwarnings('ignore')

parser = argparse.ArgumentParser(description='CMC training')
...
parser.add_argument('--mask_type', type=str, default='t+s', help='opt+opt opt: [t/f/s](b/c/cb/cc)')
# training
...
parser.add_argument('--logdir', type=str, default='log_cmc', help='directory to save weights and logs')
