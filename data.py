""" This file contains functions for loading and preprocessing datasets.
...
def split_data_label(X_trial, y_trial, sample_timestamps, overlapping, keep_dim=False):
    ...
    Args:
        ...
        keep_dim (bool): Whether to keep the dimension of the data after splitting. If True, the data will keep the trial dimension.
...
def np_normalize(X, axis=1):
    ...
    Args:
        ...
        axis (int): The axis along which to normalize the data. Default is 1.
