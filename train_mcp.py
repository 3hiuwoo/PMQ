...
parser.add_argument('--data', type=str, default='chapman', choices=['chapman', 'chapman_lead', 'chapman_trial'], help='the dataset to be used', choices=['chapman', 'chapman_lead', 'chapman_trial'])
