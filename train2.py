...
parser.add_argument('--proj_dim', type=int, default=None, help='projection head dimension, None for no projection head')
...
parser.add_argument('--mask_type', type=str, default='t+sb', help='opt+opt opt: [t/f/s](b/c/cb/cc)')
# training
